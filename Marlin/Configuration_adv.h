 ...
 */
 ...
 //#define MESH_MIN_X MESH_INSET
  #define MESH_MIN_Y MESH_INSET      //IMO - old value:3
  #define MESH_MAX_X X_BED_SIZE - (MESH_INSET)    //IMO - old value:204
  #define MESH_MAX_Y Y_BED_SIZE - (MESH_INSET)    //IMO - old value:229
#endif
