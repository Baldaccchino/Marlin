...
#define STRING_CONFIG_H_AUTHOR "(Baldacchino, Ender-3 Pro)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  28.72,  28.72 }    //IMO - 22.20 22.20
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 96.30630 }   //IMO - last value: 99.86
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 5, 25  }    //IMO - { 200, 200, 5, 25 } 
 ...
 */
//#define CLASSIC_JERK  //IMO - had it on
...
#define PROBING_MARGIN 0  //default 10
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT  ((X_BED_SIZE - 10) / 2)  // X_CENTER X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT  ((Y_BED_SIZE - 10) / 2) // Y_CENTER Y point for Z homing
#endif
